    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      a = n.Token = function(e, t, n, a, r) {
        this.type = e, this.content = t, this.alias = n, this.length =
          0 | (a || "").length, this.greedy = Boolean(r);
      };
    if (
        ...
        a.stringify = function(e, t, r) {
          ...
          if (
            ...
            var l = n.util.type(e.alias) === "Array" ? e.alias : [e.alias];
            Array.prototype.push.apply(i.classes, l);
          }
          n.hooks.run("wrap", i);
          var o = Object.keys(i.attributes).
            map(
              (e) => `${e}="${(i.attributes[e] || "").replace(/"/g, "&quot;")}"`
            ).
            join(" ");
...
typeof module != "undefined" &&
  module.exports &&
  (module.exports = Prism), typeof global != "undefined" &&
  (global.Prism = Prism);
Prism.languages.markup = {
  ...
  Prism.languages.markup.entity, Prism.hooks.add("wrap", (a) => {
...
Prism.languages.actionscript = Prism.languages.extend("javascript", {
  ...
  operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/
}), Prism.languages.actionscript["class-name"].alias = "function", Prism.
  languages.markup &&
...
}), Prism.languages.aspnet.tag.pattern = /<(?!%)\/?[^\s>\/]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\s\S])*\1|[^\s'">=]+))?)*\s*\/?>/i, Prism.languages.insertBefore(
  "inside",
  "punctuation",
...
Prism.languages.bison = Prism.languages.extend(
  "c",
  {}
...
Prism.languages.django = Prism.languages.extend("markup", {
  comment: /(?:<!--|{#)[\s\S]*?(?:#}|-->)/
}), Prism.languages.django.tag.pattern = /<\/?(?!\d)[^\s>\/=$<]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\s\S])*\1|[^>=]+))?)*\s*\/?>/i, Prism.languages.insertBefore(
  "django",
  "entity",
  _django_template
), Prism.languages.insertBefore(
...
Prism.languages.elixir = {
  ...
  punctuation: /<<|>>|[.,%\[\]{}()]/
}, Prism.languages.elixir.string.forEach((e) => {
  e.inside = {
    interpolation: {
      pattern: /#\{[^}]+\}/,
      inside: {
...
Prism.languages.groovy = Prism.languages.extend("clike", {
  ...
  if (e.language === "groovy" && e.type === "string") {
    ...
    if (t != "'") {
      var n = /([^\\])(\$(\{.*?\}|[\w\.]+))/;
      t === "$" &&
        (n = /([^\$])(\$(\{.*?\}|[\w\.]+))/), e.content = e.content.
        replace(/&lt;/g, "<").
        replace(/&amp;/g, "&"), e.content = Prism.highlight(e.content, {
        expression: {
          pattern: n,
          lookbehind: !0,
...
!(function(e) {
  ...
  }), e.hooks.add("before-highlight", (e) => {
    e.language === "handlebars" &&
      (
        e.tokenStack = [],
        e.backupCode = e.code,
        e.code = e.code.replace(a, (a) => {
          for (
            var n = e.tokenStack.length;
            e.backupCode.indexOf(`___HANDLEBARS${n}___`) !== -1;
  ...
  }), e.hooks.add("before-insert", (e) => {
    e.language === "handlebars" &&
      (e.code = e.backupCode, delete e.backupCode);
  }), e.hooks.add("after-highlight", (a) => {
    if (a.language === "handlebars") {
...
}), Prism.languages.haxe.string.inside.interpolation.inside.rest = Prism.util.clone(
...
Prism.languages.inform7 = {
  ...
  punctuation: /[.,:;(){}]/
}, Prism.languages.inform7.string.inside.substitution.inside.rest = Prism.util.clone(
  Prism.languages.inform7
...
}), delete Prism.languages.jolie["class-name"], delete Prism.languages.jolie.
  function, Prism.languages.insertBefore("jolie", "keyword", {
  function: {
...
Prism.languages.parigp = {
  ...
  keyword: (function() {
    ...
    return r = r.map((r) => r.split("").join(" *")).join("|"), RegExp(
      `\\b(?:${r})\\b`
    );
  }()),
  function: /\w[\w ]*?(?= *\()/,
...
Prism.languages.php = Prism.languages.extend("clike", {
  ...
  (
    Prism.hooks.add("before-highlight", (e) => {
      e.language === "php" &&
        (/(?:<\?php|<\?)/gi).test(e.code) &&
        (
          e.tokenStack = [],
          e.backupCode = e.code,
          e.code = e.code.replace(/(?:<\?php|<\?)[\s\S]*?(?:\?>|$)/gi, (a) => {
            for (
              var n = e.tokenStack.length;
              e.backupCode.indexOf(`___PHP${n}___`) !== -1;
    ...
    Prism.hooks.add("before-insert", (e) => {
      e.language === "php" &&
        e.backupCode &&
        (e.code = e.backupCode, delete e.backupCode);
    }),
    Prism.hooks.add("after-highlight", (e) => {
      if (e.language === "php" && e.tokenStack) {
        ...
        for (var a = 0, n = Object.keys(e.tokenStack); a < n.length; ++a) {
          ...
          e.highlightedCode = e.highlightedCode.replace(
            `___PHP${t}___`,
            `<span class="token php language-php">${Prism.highlight(
              r,
              e.grammar,
              "php"
            ).replace(/\$/g, "$$$$")}</span>`
...
}), Prism.languages.processing.function.pattern = /[a-z0-9_]+(?=\s*\()/i, Prism.languages.processing[
  "class-name"
].alias =
  "variable";
...
!(function(e) {
  ...
  e.languages.puppet.heredoc[0].inside.interpolation = n, e.languages.puppet.string.inside[
    "double-quoted"
  ].inside.interpolation = n;
}(Prism));
!(function(e) {
  ...
  t.forEach((t) => {
    var r = t;
    if (
      typeof t != "string" && (r = t.alias, t = t.lang), e.languages[r]
    ) {
      var i = {};
      i[`inline-lang-${r}`] = {
        pattern: RegExp(
          a.replace("{lang}", t.replace(/([.+*?\/\\(){}\[\]])/g, "\\$1")),
          "i"
        ),
        inside: e.util.clone(e.languages.pure["inline-lang"].inside)
      }, i[`inline-lang-${r}`].inside.rest = e.util.clone(
        e.languages[r]
      ), e.languages.insertBefore("pure", "inline-lang", i);
    }
  }), e.languages.c &&
    (e.languages.pure["inline-lang"].inside.rest = e.util.clone(e.languages.c));
}(Prism));
...
!(function(e) {
  ...
  }), delete e.languages.sass.property, delete e.languages.sass.
    important, delete e.languages.sass.
    selector, e.languages.insertBefore("sass", "punctuation", {
    selector: {
      pattern: /([ \t]*)\S(?:,?[^,\r\n]+)*(?:,(?:\r?\n|\r)\1[ \t]+\S(?:,?[^,\r\n]+)*)*/,
      lookbehind: !0
    }
...
Prism.languages.scala = Prism.languages.extend("java", {
  ...
  symbol: /'[^\d\s\\]\w*/
}), delete Prism.languages.scala["class-name"], delete Prism.languages.scala.
  function;
  ...
  e.languages.smarty = e.languages.extend("markup", {
    ...
    e.language === "smarty" &&
      (
        e.tokenStack = [],
        e.backupCode = e.code,
        e.code = e.code.replace(t, (t) => {
          if (t === n && (o = !1), !o) {
            t === a && (o = !0);
            for (
              var r = e.tokenStack.length;
              e.backupCode.indexOf(`___SMARTY${r}___`) !== -1;
    ...
    e.language === "smarty" && (e.code = e.backupCode, delete e.backupCode);
  }), e.hooks.add("after-highlight", (t) => {
    if (t.language === "smarty") {
      for (var a = 0, n = Object.keys(t.tokenStack); a < n.length; ++a) {
        var o = n[a],
          r = t.tokenStack[o];
        t.highlightedCode = t.highlightedCode.replace(
          `___SMARTY${o}___`,
...
!(function(e) {
  ...
  e.languages.textile.tag.pattern = /<\/?(?!\d)[a-z0-9]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\s\S])*\1|[^\s'">=]+))?)*\s*\/?>/i, e.languages.textile.phrase.inside.inline.inside.bold.inside = t, e.languages.textile.phrase.inside.inline.inside.italic.inside = t, e.languages.textile.phrase.inside.inline.inside.inserted.inside = t, e.languages.textile.phrase.inside.inline.inside.deleted.inside = t, e.languages.textile.phrase.inside.inline.inside.span.inside = t, e.languages.textile.phrase.inside.table.inside.inline =
    t.inline, e.languages.textile.phrase.inside.table.inside.link =
