...
require (
	...
	github.com/gobuffalo/buffalo-heroku v1.0.8 // indirect
	github.com/gobuffalo/clara v0.8.2
	...
	github.com/markbates/pkger v0.0.0-20190830175641-68f3a2a4571d // indirect
