...
<%= partial("en/docs/forms/form.md") %>
<%= partial("en/docs/forms/form_for.md") %>
<%= partial("en/docs/forms/select_tag.md") %>
<%= partial("en/docs/forms/checkbox.md") %>
<%= partial("en/docs/forms/errors.md") %>
<%= partial("en/docs/forms/non_bootstrap.md") %>
