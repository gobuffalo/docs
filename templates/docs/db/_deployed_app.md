...
When you build your app, the fizz migrations are stored inside your binary. Your binary has a hidden migrate command baked in that performs the migrations just like it does when you use `buffalo db migrate`.
