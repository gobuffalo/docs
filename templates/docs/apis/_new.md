...
| `buffalo new coke --api`              | `buffalo new coke`                    |
|---------------------------------------|---------------------------------------|
| <%= partial("docs/apis/api_ls.md") %> | <%= partial("docs/apis/web_ls.md") %> |
...
| `buffalo new coke --api`              | `buffalo new coke`                    |
|---------------------------------------|---------------------------------------|
| <%= partial("docs/apis/api_app.md") %> | <%= partial("docs/apis/web_app.md") %> |
| <%= partial("docs/apis/api_render.md") %> | <%= partial("docs/apis/web_render.md") %> |
